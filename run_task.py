...
from dataset.ms_marco_data import MSTripletData, get_data_loader
...
def run(args):
    ...
    # pid_2_passage_token_ids_path = os.path.join(
    #     data_root, "pid_2_passage_token_ids.pkl"
    # )
    ...
    dataset = MSTripletData(
        args.triplet_path,
        args.pid_2_passage_token_ids_path,
        args.qid_2_query_token_ids_path,
        args.tokenizer_name,
