...
class KLDivergenceDistillLoss(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(KLDivergenceDistillLoss, self).__init__()
    ...
    def forward(
        ...
        loss = self.kl_div_loss(teacher_scores_normalized, student_scores_normalized)
        return loss
...
def _test():
    ...
    loss_fn = KLDivergenceDistillLoss()
