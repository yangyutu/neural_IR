...
query_embed_path=./experiments/precomputed_embeddings/hard_neg_prepare/query_embed.pkl
...
--triplet_file ${msmarco_data_root}/triplets/qidpidtriples.train.tiny.2.tsv \
--passage_collection ${msmarco_data_root}/collection.tsv \
--query_collection ${msmarco_data_root}/queries.train.tsv \
--query_embedding_path ${query_embed_path} \
