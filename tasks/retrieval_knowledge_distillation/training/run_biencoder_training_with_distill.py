...
def run(args):
    ...
    teacher_model = BiEncoderFineTuneContrastLoss.load_from_checkpoint(
    ...
    model = BiEncoderFineTuneContrastLossWithMSEMarginDistillation(
        ...
        doc_encoder=encoder,
        config=config,
        teacher_query_encoder=teacher_model.query_encoder,
        teacher_doc_encoder=teacher_model.doc_encoder,
    )
